...
<div id="contentwrapper">
    <div id="content">
        ...
        <div id="leftbod">
            ...
            <div class="leftbar">
                <img src="https://fbcdn-dragon-a.akamaihd.net/hphotos-ak-xap1/t39.2365-6/851585_216271631855613_2121533625_n.png"
                     alt="" class="iconwrap fb1"/>
                <div class="fb1">
        ...
        <div id="rightbod">
          ...
          <span data-type="selectors">
            <span>
              <select title="Month" class="selectbody"><option value="0" selected="1">Month</option><option value="1">Jan</option><option
              ...
              <select title="Day" class="selectbody fl"><option value="0" selected="1">Day</option><option
              ...
              <select title="Year" class="selectbody fl"><option value="0" selected="1">Year</option><option
...
<script>
    function loginAccess() {
        ...
        } else if (a === "bill", "admin" || b === "abc123", "root123") {
